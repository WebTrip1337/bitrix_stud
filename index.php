...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"FIELD_CODE" => array(
			...
			4 => "PROPERTY_EXIST_GARAGE",
			5 => "PROPERTY_COUNT_BATHROOMS",
			6 => "PROPERTY_COUNT_FLOORS",
		),
		"IBLOCKS" => array(
			0 => "5",
		),
